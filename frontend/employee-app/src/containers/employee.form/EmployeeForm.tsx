      ...
      <form className="layout-child-div" onSubmit={props.onsubmit}>
        <div className="form-container">
          <Input
            ...
            onchange={(event) => {
              props.formOnChange(event.target.name, event.target.value);
            }}
          />
          <Input
            label="Joining Date"
            ...
            value={String(props.values.dateOfJoining)}
            onchange={(event) => {
              props.formOnChange(event.target.name, event.target.value);
            }}
          />
          ...
          <Input
            ...
            variant="input"
            placeholder="Age"
            value={String(props.values.age)}
            onchange={(event) => {
              props.formOnChange(event.target.name, Number(event.target.value));
            }}
          />
          ...
          <Input
            ...
            value={String(props.values.experience)}
            onchange={(event) => {
              props.formOnChange(event.target.name, Number(event.target.value));
            }}
          />
          ...
          <div className="form-element address-input">
            ...
            <input
              ...
              name="houseNo"
              placeholder="Flat no"
              value={props.values.address?.houseNo}
              onChange={(event) => {
                props.formOnChange(event.target.name, event.target.value);
              }}
            />
            ...
            <input
              ...
              name="line2"
              placeholder="Line 2"
              value={props.values.address?.line2}
              onChange={(event) => {
                props.formOnChange(event.target.name, event.target.value);
              }}
            />
        ...
        <div>
          <Button
            ...
            type="submit"
            text={props.type === "Create" ? "Create" : "Edit"}
          />
          <Button
            variant="grey"
            className="button-form"
